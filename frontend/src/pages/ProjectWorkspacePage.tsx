...
export function ProjectWorkspacePage() {
  ...
  return (
    <div>
      ...
      {activeTab === 'tasks' ? <div className="mt-7"><TasksPanel projectId={project.id} role={project.role} /></div> : activeTab === 'documents' ? <div className="mt-7"><DocumentsPanel projectId={project.id} role={project.role} /></div> : activeTab === 'overview' ? <><div className="mt-7 grid gap-4 sm:grid-cols-3">
